    ...
    return (
        <div className="page3 twofixed">
            <div className="First_Screen">
                ...
                <div className="Screen2">
                    <div className="window1 P2 S2-P2">
                        <h1 className="main-header-second-h2 head2 P2 S2-P2">MISSION</h1>
                        <p className="window1-descript P2 S2-P2 page3">We founded IDN to address an evident  <span className="main-post-link P2 S2-P2"> market gap: to </span> meet inverstors’ demand to
                            access proprietary, bilateral deals.
                            <span className="yellow-upper"> We just created the right incentives and conditions to stimulate the offer</span>
                        </p>
                    </div>
                    ...
                    <div className="window1 Screen6--w2 Screen5--w2 S6 P5-S6">
                        <div className="Screen5--decription S5 S52 P5-S6">
                            ...
                            <div className="Screen5--description--content S6c P5-S6">
                                ...
                                <p className="Screen5--p P1-S6 P5-S6">We have deep knowledge of Private Equity and
            ...
            <div className="our-team">
                ...
                <p className="text-big text-S2-P4 P4 S2 center foot-head P5-our-team P5">IDN is backed by dozens of prominent Senior Executives and<br/>
                Private <span className="main-post-link P2 S2-P2 text-big text-S2-P4 P4 S2 center P5-our-team"> Equity investors across</span> Europe!</p>
            </div>
