...
function TermsPage(props) {
    ...
    return (
        <div className="Terms">
            ...
            <ul>
                ...
                <li>
                    <ul>
                        ...
                        <li>v. the Advisor has sufficient skill and experience to understand in full its contractual,
                            regulatory and legal obligations and the implications of publishing the Opportunity;
                        </li>
                        <li>vi. the Advisor has not been induced to publish the Opportunity by IDN; and</li>
                        <li>vii. IDN is not qualified to provide, and has not provided Advice to the Advisor in
                            relation to
                    ...
                    <ul>
                        ...
                        <li>
                            <ul>
                                ...
                                <li>(ii) all necessary access to such information as may be required by IDN, in order to
                                    provide
            ...
            <ul>
                ...
                <li>
                    <ul>
                        ...
                        <li>
                            <ul>
                                <li>(i) attempt to copy, modify, duplicate, create derivative works from, frame, mirror,
                                    republish,
                                    download, display, transmit, or distribute all or any portion of the Platform in any
                                    form or
                                    media or by any means; or
                                </li>
                                <li>(ii) attempt to de-compile, reverse compile, disassemble, reverse engineer or
                                    otherwise
                                    reduce to
            ...
            <h2>10. What are IDN’s rights and obligations?</h2>
            <ul>
                <li>10.1 In providing Advisors with access to the Platform and/or the Services, IDN reserves
                    ...
                    <ul>
                        ...
                        <li>
                            <ul>
                                ...
                                <li>(ii) the Platform or the Services will be free from a weakness in the computational
                                    logic
                                    (for
                                ...
                                <li>(iii) the Platform or Services will comply with any laws, regulations, codes,
                                    guidance (from
                                ...
                                <li>(iv) the Advisor’s use of the Platform and/or the Services will be uninterrupted or
                                    error-free,
            ...
            <ul>
                <li>10.3 The Advisor acknowledges and agrees that IDN is not responsible or liable for the
                ...
                <li>10.4 IDN warrants that it has and will maintain all necessary licences, consents, and permissions
                    necessary for the performance of its obligations under these Terms.
                </li>
            </ul>
            <h2>11. How does IDN use Your personal data?</h2>
            <ul>
                <li>11.1 The following definitions shall apply to this paragraph 11:<p><strong>Controller, processor,
                    data
                ...
                <li>11.2 The Advisor shall own all right, title and interest in and to all of the Advisor Data that
                ...
                <li>11.3 The Advisor and IDN will comply with all applicable requirements of the Data Protection
                ...
                <li>11.5 Without prejudice to the generality of paragraph 11.3, the Advisor will ensure that it has
                ...
                <li>11.6 Without prejudice to the generality of paragraph 11.3, IDN shall, in relation to any
                ...
                <li>
                    <ul>
                        ...
                        <li>
                            <ul>
                                <li>(i) the Advisor or IDN has provided appropriate safeguards in relation to the
                                    transfer;
                                </li>
                                <li>(ii) the data subject has enforceable rights and effective legal remedies;</li>
                                <li>(iii) IDN complies with its obligations under the Data Protection Legislation by
                                    providing an
                                    adequate level of protection to any personal data that is transferred; and
                                </li>
                                <li>(iv) IDN complies with reasonable instructions Notified to it in advance by the
                                    Advisor with
                ...
                <li>11.7 Each of IDN and the Advisor shall ensure that it has in place appropriate technical and
                ...
                <li>11.8 Either of IDN or the Advisor may at any time on not less than thirty (30) days' notice,
            ...
            <ul>
                <li>12.1 Each of the Advisor and IDN may be given access to information that is proprietary
                ...
                <li>12.2 Subject to paragraph 12.5, each of IDN and the Advisor shall hold the other's Confidential
                ...
                <li>12.3 Each of IDN and the Advisor shall take all reasonable steps to ensure that the other's
                ...
                <li>12.4 The Advisor represents and warrants that the disclosure of any information via the Platform
                ...
                <li>12.5 Notwithstanding the foregoing, a party may disclose Confidential Information to the extent
                ...
                <li>12.6 The Advisor acknowledges that details of the Services, and the results of any performance
                    tests of the Services, constitute IDN’s Confidential Information.
                </li>
                <li>12.7 IDN acknowledges that the Advisor Data is the Confidential Information of the Advisor.</li>
                <li>12.8 No party shall make, or permit any person to make, any public announcement concerning these
                ...
                <li>12.9 The above provisions of this paragraph 12 shall survive termination of these Terms, however
                    arising.
                </li>
            </ul>
            <h2>13. Term and termination</h2>
            <ul>
                <li>13.1 These Terms shall, unless otherwise terminated as provided in this paragraph 13,
                ...
                <li>13.2 Without affecting any other right or remedy available to it, IDN may terminate these
                ...
                <h2>14. How has IDN limited its liability?</h2>
                <ul>
                    <li>14.1 IDN is not responsible for any delays, delivery failures, or any other loss or
                    ...
                    <li>14.2 IDN shall have no liability to the Advisor under these Terms if it is prevented from
            ...
            <ul>
                ...
                <li>14.6 The Advisor irrevocably agrees to indemnify IDN against all costs, damages, fines, losses
            ...
            <h2>15. Who owns the Platform?</h2>
            <ul>
                <li>15.1 IDN and its licensor(s) are the sole owners of the Platform, which includes any
                ...
                <li>15.2 IDN permits each Advisor to use the Platform for its own personal and/or commercial
                    use subject to these Terms and IDN grants each Advisor a limited and non-transferable
                    licence solely for that purpose.
                </li>
                <li>15.3 An Advisor may not sell, export, license, modify, copy, distribute or transmit the
                    Platform (or any part of it) without IDN's prior express written consent.
                </li>
                <li>15.4 Any unauthorised use of the Platform may result in the termination of the limited
                ...
                <li>15.5 IDN and its graphics, logos, icons and service names related to the Platform are
                ...
                <li>15.6 All other trademarks not owned by IDN that appear in connection with the Platform
            ...
            <h2>16. What security measures does IDN have in place?</h2>
            <ul>
                <li>16.1 Whilst IDN has implemented commercially reasonable technical and organisational
                ...
                <li>16.2 Each Advisor acknowledges that he provides personal information and Advisor Data at
                    his own risk.
                </li>
                <li>16.3 By downloading, using and/or accessing in any way the Platform and/or material
                    provided through the Platform, each Advisor consents to receiving electronic
                    communications and notices from IDN.
                </li>
                <li>16.4 Each Advisor agrees that any notice, agreement, disclosure or other communications
            ...
            <ul>
                <li>17.1 From time to time You may find links to third-party websites on the Platform. These links
                ...
                <li>17.2 From time to time an Advisor may use or access services, promotions and websites of third
            ...
            <h2>18. General</h2>
            <ul>
                <li>18.1 IDN may change or discontinue the Services and/or Platform at any time without prior
                ...
                <li>18.2 These Terms are agreed between the Advisor and IDN. No other person shall have any
                    rights under or connection with these Terms and Conditions under the Contracts (Rights
                    of Third Parties) Act 1999.
                </li>
                <li>18.3 If any court or competent authority decides that any provision of these Terms is
            ...
            <ul>
                <li>18.4 IDN’s failure to enforce any provision of these Terms shall not constitute a waiver of that
                    or any other provision and will not relieve an Advisor from the obligation to comply with such
                    provision.
                </li>
                <li>18.5 No Advisor is permitted to assign, transfer, charge, sub-contract or deal in any other
                ...
                <li>18.6 These Terms and each of the documents referenced herein set forth the entire understanding
                    and agreement between each Advisor and IDN with respect to the subject matter hereof.
                </li>
                <li>18.7 These Terms, their subject matter and formation (and any non-contractual disputes or claims)
                    are governed by the laws of England and Wales. IDN and the Advisor agree to be subjected to the
                    exclusive jurisdiction of the courts of England and Wales.
                </li>
                <li>18.8 Notices shall be served by IDN on the Advisor by email to the email address associated with
                    the Advisor’s account at the date the notice is sent.
                </li>
                <li>18.9 Notices may only be served on IDN at its registered office address from time to time and
                ...
                <li>18.10 Nothing in these Terms is intended to or shall operate to create a partnership between IDN
            ...
            <table className="first--table">
                ...
                <tr>
                    <td>
                        <strong>Applicable Laws</strong></td>
                    <td>
                        <p>has the meaning given in paragraph 11.6(i);</p></td>
                </tr>
                <tr>
                    <td>
                        <strong>Binding Offer</strong></td>
                    <td>
                ...
                <tr>
                    <td>
                        <strong>Closed and Completion</strong></td>
                    <td>
                ...
                <tr>
                    <td>
                        <strong>Competitive Process</strong></td>
                    <td>
                ...
                <tr>
                    <td>
                        <strong>Confidential Information</strong></td>
                    <td>
                ...
                <tr>
                    <td>
                        <strong>Consultancy Offer</strong></td>
                    <td>
                ...
                <tr>
                    <td>
                        <strong>Consultancy Work</strong></td>
                    <td>
                ...
                <tr>
                    <td>
                        <strong>Domestic UK Law</strong></td>
                    <td>
                        <p>has the meaning given in paragraph 11.6(i);</p></td>
                </tr>
                <tr>
                    <td>
                        <strong>Effective Date</strong></td>
                    <td>
                        <p>the date on which the first of the events set out in paragraph 2.2 occurs;</p></td>
                </tr>
                <tr>
                    <td>
                        <strong>Enterprise Value</strong></td>
                    <td>
                        <p>(i) the total amount of cash and the fair market value (on the date of Closing of the
                ...
                <tr>
                    <td>
                        <strong>Fully Diluted Share Capital</strong></td>
                    <td>
                ...
                <tr>
                    <td>
                        <strong>IDN Commission</strong></td>
                    <td>
                ...
                <tr>
                    <td>
                        <strong>LCIA Rules</strong></td>
                    <td>
                        <p>the &nbsp;&nbsp;LCIA &nbsp;&nbsp;Arbitration &nbsp;&nbsp;Rules &nbsp;&nbsp;which &nbsp;&nbsp;can &nbsp;&nbsp;be &nbsp;&nbsp;found &nbsp;&nbsp;at</p>
                        <p>https://www.lcia.org/Dispute
                            Resolution Services/lcia-arbitration-rules-2020.aspx (as
                            updated from time to time);</p></td>
                </tr>
                <tr>
                    <td>
                        <strong>Long Stop Notice</strong></td>
                    <td>
                        <p>has the meaning given in paragraph 5.13;</p></td>
                </tr>
                <tr>
                    <td>
                        <strong>Mandate Requirements</strong></td>
                    <td>
                ...
                <tr>
                    <td>
                        <strong>Non-Binding Offer</strong></td>
                    <td>
                ...
                <tr>
                    <td>
                        <strong>Origination Mandate Introduction Fee</strong></td>
                    <td>
                ...
                <tr>
                    <td>
                        <strong>Pre Introduction</strong>
                        <strong>Termination Notice</strong></td>
                    <td>
                        <p>has the meaning given in paragraph 5.11;</p></td>
                </tr>
                <tr>
                    <td>
                        <strong>Privacy Policy</strong></td>
                    <td>
                ...
                <tr>
                    <td>
                        <strong>Representatives</strong></td>
                    <td>
            ...
            <p>In these Terms:</p>
            <p>(i) any reference to any gender includes any reference to the other genders; and</p>
            <p>(ii) a reference to a person includes a corporate or unincorporated body or association (whether or not
                ...
                <tr>
                    <td>
                        <strong>Enterprise Value of Target in proportion to the share of the Fully Diluted Share Capital
                            of
                            the Target when the is Transaction Closed (£)*</strong></td>
                    <td>
                        <strong>Success Fee (%)</strong></td>
                    <td>
                        <strong>Minimum to Maximum Success Fee Threshold (£)</strong></td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <strong>Enterprise Value of Target in proportion to the share of the Fully Diluted Share Capital
                            ...
                            the Target when the is Transaction Closed (£)*</strong></td>
                    <td>
                        <strong>Amount of Origination Mandate Introduction Fee (£)</strong></td>
                </tr>
                <tr>
                    <td>
                        <p>Small cap (£1-50mil)</p></td>
            ...
            <ul>
                ...
                <li>
                    <ul>
                        ...
                        <li>(ii) the Firm may disclose Confidential Information to an Advisor as part of evaluating an
            ...
            <p>Notice (as applicable) (the <strong>“Termination Date”</strong>), each of the Firm and the Advisor, and
                its
                Representatives, shall continue to be bound by the non-disclosure obligations of this agreement with
                respect to any Confidential Information held by them, save that with effect from the Termination Date
            ...
            <ul>
                ...
                <li>
                    <ul>
                        <li>(a) offering the Opportunity to any other person save that the Advisor may offer the
                        ...
                        <li>(b) (in the case of the Firm) after the Termination Date directly or indirectly (including
                        ...
                        <li>(c) acting, or inducing any other person to act, otherwise than in good faith towards IDN.
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <ul>
                        <li>(a) if on receipt of the name of the Target (the “Disclosure Time”), the Firm realises that
                            it is
                        ...
                        <li>(b) the evidence referenced in (a) above shall be sanitised written documentation or
            ...
            <h3>10. The provisions of paragraph 18 of the Terms shall apply to this agreement.</h3>
        </div>
    )
}
